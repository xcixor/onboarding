...
const PrivacyPolicy = () => {
  return (
    <div className="mx-auto max-w-4xl p-4">
      ...
      <p className="mb-3 text-pes-blue">Last updated: February 27, 2024</p>
      ...
      <h2 className="mb-3 text-3xl font-semibold text-pes-red">
      ...
      <h3 className="mb-3 text-2xl font-semibold text-pes-red">Definitions</h3>
      <p className="mb-3 text-pes-blue">
      ...
      <ul className="list-disc pl-4 text-pes-blue">
        ...
        <li className="m-3">
          <p>
            ...
            this Agreement) refers to Private Equity Support, 5th Floor, Timau
            Plaza, Argwings Kodhek Road, Nairobi, Kenya.
          </p>
        </li>
        <li className="m-3">
          <p>
        ...
        <li className="m-3">
          <p>
            ...
            <Link
              ...
              target="_blank"
              className="text-pes-red"
            >
              https://academy.privateequity-support.com/
            </Link>
          </p>
        </li>
        <li className="m-3">
      ...
      <h4 className="mb-3 text-xl font-semibold text-pes-red">Personal Data</h4>
      <p className="mb-3 text-pes-blue">
      ...
      <h4 className="mb-3 text-xl font-semibold text-pes-red">Usage Data</h4>
      <p className="mb-3 text-pes-blue">
      ...
      <h4 className="mb-3 text-xl font-semibold text-pes-red">
      ...
      <p className="mb-3 text-pes-blue">
        ...
        already associated with Your Third-Party Social Media Service&rsquo;s
      ...
      <p className="mb-3 text-pes-blue">
        ...
        Company through Your Third-Party Social Media Service&rsquo;s account.
      ...
      <h2 className="mb-3 text-3xl font-semibold text-pes-red">Contact Us</h2>
      <p className="mb-3 text-pes-blue">
      ...
      <ul className="list-disc pl-4 text-pes-blue">
        ...
        <li className="m-3">
          <p>
            ...
            <Link
              href="https://academy.privateequity-support.com/privacy"
              rel="external nofollow noopener"
              target="_blank"
              className="text-pes-red"
            >
              https://academy.privateequity-support.com/privacy
            </Link>
          </p>
        </li>
      </ul>
