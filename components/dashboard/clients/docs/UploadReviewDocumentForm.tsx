...
interface UploadReviewDocumentFormProps {
  initialData: GCPData;
  reviewId: string;
  isDeleting: boolean;
  assetId: string;
...
export default function UploadReviewDocumentForm({
  initialData,
  reviewId,
  isDeleting,
  assetId,
}: UploadReviewDocumentFormProps) {
  ...
  return (
    <div className="mt-6 rounded-md border bg-slate-100 p-4">
      ...
      {isEditing && (
        <div>
          <FileUpload
            bucketFileDirectory={`courses/${reviewId}/attachments`}
